  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="text-4xl md:text-6xl font-bold mb-4 text-[var(--text)]"
      >
      ...
      <motion.p
        ...
        className="text-lg text-[var(--primary)] font-medium mb-4"
      >
        {t.hero.title}
      </motion.p>
      ...
      <motion.p
        ...
        className="text-[var(--text-secondary)] max-w-xl mb-8 text-base leading-relaxed"
      >
        {t.hero.description}
      </motion.p>
